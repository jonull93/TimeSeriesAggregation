...
class TestDataProcessor(unittest.TestCase):
    ...
    def test_process_outdata_clusters(self):
        ...
        new_data = process_outdata_clusters(clusters, header, scaling_factors, index_method='first')
        self.assertIsNotNone(new_data)
        ...
        new_data_with_refindex = process_outdata_clusters(clusters, header, scaling_factors, index_method='first', ref_index=original_df.index)
